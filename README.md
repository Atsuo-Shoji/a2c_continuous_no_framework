...
原因としては、環境BipedalWalkerの性質かもしれません。<br>
...
2000ステップという長大なエピソードだと、エピソード毎の行動のバリエーションがありすぎて、どのような（その長い一連の）行動を取ればそのような報酬がもたらされるのか、2.5万回程度のイテレーションではイマイチ学習し切れないのかもしれません。
